...
If you are already familiar with this modeling framework and ready to get started, skip ahead to [get your modelModelingWork.html){target='blank'}.
...
#### What's next?
+ learn what a [state-and-transition modeVegetationModeling.html){target='blank'} (STSM) is
