...
```{r firstPhoto, echo = FALSE}
cap_txt <- "Photo: © Marci Eggers, TNC."
alt_txt <- "I really want some coffee."
title_txt <- "Close-up of of fern about to spring open in the Atlantic Forest rainforest, Guaraquecaba, Brazil"
img_location <- "images/fern.jpg"
```
...
```{r screenTransTypes, echo = FALSE}
cap_txt <- "Screenshot of Transition Types"
alt_txt <- "I really want some coffee."
title_txt <- "Screenshot of a dropdown menu titled Transition type with the following options: Native grazing, alternative succession, competition or maintenance, insects of disease, mixed fire, native grazing, Optional 1, Optional 2, replacement fire, surface fire, wind or weather stress"
img_location <- "images/disturbance.jpg"
```
...
```{r alterStates, echo = FALSE}
cap_txt <- "Screenshot of Transition Types"
alt_txt <- "I really want some coffee."
title_txt <- "Screenshot of a dropdown menu titled Scenario all models, Transition pathways is selected, the tab To class is selected with multiple dropdown options viewable."
img_location <- "images/states.jpg"
```
...
```{r caliFire, echo = FALSE}
cap_txt <- "© Ben Jiang, TNC. One of the 2018 California wildfires."
alt_txt <- "I really want some coffee."
title_txt <- "Intense wildfire in background with fire approaching a city and body of water in foreground."
img_location <- "images/califorina.jpg"
```
...
```{r nebraska, echo = FALSE}
cap_txt <- "© Chris Helzer, TNC. Niobrara River near the headquarters of The Nature Conservancy's Nebraska Niobrara Valley Preserve after the 2012 wildfire."
alt_txt <- "I really want some coffee."
title_txt <- "Landscape picture where prescribed fire has recently been completed with river winding through green deciduous trees in background and emerging grasses in foreground and sunrise in the distance."
img_location <- "images/nebraska.jpg"
```
...
```{r largeFire, echo = FALSE}
cap_txt <- "© Stavros Mitchelides, TNC Photo Contest 2019. Dense wildfire smoke in Banff National Park"
title_txt <- "Hiker hiking along ridge in Bamff National Park, dense wildfire smoke surrounding landscape."
img_location <- "images/large-fire.jpg"
```
...
```{r soilHand, echo = FALSE}
cap_txt <- "© Devan King/TNC"
title_txt <- "Hand picking through soil."
img_location <- "images/soil.jpg"
```
