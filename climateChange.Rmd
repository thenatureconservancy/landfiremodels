...
<center>
```{r, echo=FALSE, out.width='65%', out.extra='style="float:right; padding:10px"', fig.cap="hiker hiking along ridge in Bamff National Park, dense wildfire smoke surrounding landscape"} 
