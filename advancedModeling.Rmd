...
```{r, echo=FALSE, fig.cap="Controlled burn in grasslands with dark purple sky"} 
knitr::include_graphics("images/kansas.jpg")

```
Photo: © TNC. Controlled burn in Shawnee County, Kansas
...
```{r, echo=FALSE, out.width='65%', out.extra='style="float:right; padding:10px"', fig.cap="Screenshot of the SyncroSim modeling environment, specific scenario with a blue arrow pointing to Transition Targets on the top row of tabs "} 
...
```{r, echo=FALSE, out.width='65%', out.extra='style="float:right; padding:10px"', fig.cap="Screenshot of the SyncroSim modeling environment, specific scenario with a blue arrow pointing to the tab called Advanced on the top row of tabs and Transition multipliers "} 
...
<center>
<iframe width="896" height="504" src="https://www.youtube.com/embed/TV4p4NspIME" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>
<br>
...
```{r, echo=FALSE, out.width='65%', out.extra='style="float:right; padding:10px"', fig.cap="Screenshot of the SyncroSim modeling environment, specific scenario with a blue arrow pointing to the tab called Advanced on the top row of tabs and Attributes on the left side of the screen  "} 
...
<iframe width="896" height="504" src="https://www.youtube.com/embed/b3MQfyYE6ZQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>
<br>
...
```{r, echo=FALSE, out.width='65%', out.extra='style="float:right; padding:10px"', fig.cap="Screenshot of the SyncroSim modeling environment, specific scenario with a blue arrow pointing to the tab called Run Control and blue arrow pointing to Run model spatially"} 
...
```{r, echo=FALSE, out.width='65%', out.extra='style="float:right; padding:10px"', fig.cap="Screenshot of the SyncroSim modeling environment, specific scenario with a blue arrow pointing to the tab called Transition spatial initiation multipliers"} 
