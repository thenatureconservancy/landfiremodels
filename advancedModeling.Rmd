...
We have only skimmed the surface of the possibilities to begin working in the  [ST-Sim](https://syncrosim.com/packages/){target='blank'} platform thus far. Below we will briefly describe a few more advanced modeling options to whet your appetite. Advanced modeling options and more detailed descriptions of these can be viewed at the [Apex website](http://www.apexrms.com/){target='blank'} and documentation specific to ST-Sim can be found [here](http://docs.stsim.net/){target='blank'}. Several videos linked below were developed by Apex as a part of their training materials so they are considerably longer and more detailed than other videos on this website.
...
+ see a simple set of simulations (designed to reflect climate change impacts) and how they may impact our [Inter-Mountain Basins Montane Sagebrush Steppe BpS](./GetModels.html){target='blank'}