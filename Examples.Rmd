...
```{r prairiePhoto, echo = FALSE}
cap_txt <- "Photo: © Jim Smith, TNC. Black Earth Prairie, Wisconsin"
alt_txt <- "I really want some coffee."
title_txt <- "Landscape of green grass intermixed with brown prairie with cloudy skyline and trees in background"
img_location <- "images/BlackEarthPrairieWisc.jpg"
```
...
```{r hardwoodsPhoto, echo = FALSE}
cap_txt <- "© A. Blake Bardner, TNC. Young forest in TNC's Campbell Parcel, Equinox Highlands, Vermont"
alt_txt <- "I really want some coffee."
title_txt <- "Forest landscape picture with closely spaced trees and lush, green understory"
img_location <- "images/hw.jpg"
```
