...
<iframe width="896" height="504" src="https://www.youtube.com/embed/xjaWJCe7udQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
cap_txt <- "Photo: © Mark Godfrey, TNC, Virginia Coast Reserve"
alt_txt <- "I really want some coffee."
title_txt <- "Decorative image of a coastal area in Virginia."
img_location <- "images/virginia.jpg"
```
...
<center>
```{r, echo=FALSE, out.width= "85%", fig.cap="screenshot of syncrosim packages, landfirevegmodels, stsim circled"} 
