...
#### Step 2: Download St-Sim 
There are two options for downloading and installing the St-Sim package.

+ Option 1: in the SyncroSim shell, navigate to 'File' -> 'Packages' -> select 'St-Sim state-and-transition model'-> 'Install'
<center>
...
+ Option 2: Download it here:  [ST-Sim package](https://syncrosim.com/packages/){target='blank'} 
