...
### Load your model
Once you have SyncroSim installed [(see stms tab)](./stms.html){target='blank'} and the LANDFIRE Package loaded, you will go through a few steps to isolate one model to work with. 
