...
Within SyncroSim there are a wide range of techniques available to modify a model. Here we introduce the main ways for modifying a model while working through the montane sagebrush steppe example obtained from the [Get Models](/Getmodels.html){target='blank'} page.  
